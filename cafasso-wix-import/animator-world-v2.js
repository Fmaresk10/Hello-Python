(() => {
  ...
  const css=`
    ...
    .world-v2__resource-room{position:absolute;inset:0;z-index:1;min-height:100vh;background:linear-gradient(90deg,rgba(8,31,35,.58),rgba(8,31,35,.12)),url('./assets/cafasso-biblioteca-vacia-v1.png') center/cover no-repeat}
    .cafasso-world-v2__topbar{position:relative;z-index:4}
