(() => {
  ...
  const css=`
    ...
    @keyframes cafassoCandleBreath{0%,100%{opacity:.34;transform:scale(.94)}45%{opacity:.62;transform:scale(1.04)}62%{opacity:.43;transform:scale(.98)}}
    @keyframes cafassoCandleFlicker{0%,100%{opacity:.58;transform:translate(-50%,-50%) scale(.88)}38%{opacity:.88;transform:translate(-48%,-52%) scale(1.06)}67%{opacity:.5;transform:translate(-53%,-48%) scale(.94)}}
    .world-v2__candle-glow{position:absolute;width:230px;height:230px;border-radius:50%;pointer-events:none;z-index:1;background:radial-gradient(circle,rgba(255,205,104,.3) 0,rgba(255,177,70,.12) 28%,transparent 68%);mix-blend-mode:screen;filter:blur(6px);animation:cafassoCandleBreath 3.7s ease-in-out infinite}
    .world-v2__candle-glow:after{content:"";position:absolute;left:50%;top:50%;width:26px;height:38px;border-radius:50% 50% 45% 45%;background:radial-gradient(ellipse at 50% 65%,#fff4b2 0 18%,#ffc44f 42%,rgba(255,133,31,.08) 72%,transparent 74%);filter:blur(2px);animation:cafassoCandleFlicker 1.35s ease-in-out infinite}
    .world-v2__candle-glow--left{left:1%;top:18%}
    .world-v2__candle-glow--right{right:14%;top:17%;animation-delay:-1.2s}
    .world-v2__candle-glow--right:after{animation-delay:-.35s}
  ...
  function shell(kind){
    const intro=kind==='arrival'
      ? '<span class="world-v2__candle-glow world-v2__candle-glow--left" aria-hidden="true"></span><span class="world-v2__candle-glow world-v2__candle-glow--right" aria-hidden="true"></span><div class="cafasso-world-v2__content"><div class="world-v2__arrival-note"><b>Estás en Casa</b><span>Tu recorrido comienza en este lugar. Mirá alrededor y seguí el camino cuando estés listo.</span></div></div><button class="world-v2__arrival-hotspot" data-world="house" aria-label="Explorar el mundo"><span>Explorar</span></button><button class="world-v2__resource-hotspot" data-world="resources" aria-label="Abrir recursos">Recursos</button><div class="world-v2__scene-message" aria-live="polite"></div>'
      : kind==='patio'
