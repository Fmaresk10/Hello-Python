(() => {
  ...
  const css=`
    ...
    .world-v2__resource-room{position:relative;min-height:100vh;background:linear-gradient(90deg,rgba(8,31,35,.58),rgba(8,31,35,.12)),url('./assets/cafasso-casa-interior-v2.jpg') center/cover no-repeat}
    .world-v2__book{position:absolute;padding:18px 16px;border:0;border-radius:3px;background:#68462f;color:#fff8e9;box-shadow:0 8px 18px rgba(0,0,0,.42);cursor:pointer;transform:rotate(-2deg);font-family:Georgia,serif;z-index:4}
