(()=>{
  ...
  if(!document.getElementById('cafassoCourseEditorV3Loader')){
    const s=document.createElement('script');s.id='cafassoCourseEditorV3Loader';s.src='./course-editor-v3.js?v=20260921-3';s.defer=true;document.body.appendChild(s);
  }
})();
