...
<<<<<<< HEAD
    .world-v2__journal-hotspot{position:absolute;left:51%;bottom:12%;width:112px;height:100px;padding:0;border:0;background:transparent;z-index:3;filter:drop-shadow(0 8px 7px rgba(0,0,0,.45));transform:rotate(-5deg);cursor:pointer}
    .world-v2__journal-hotspot img{display:block;width:112px;height:100px;object-fit:contain}
    .world-v2__journal-hotspot:hover{transform:rotate(-5deg) translateY(-4px);filter:brightness(1.08) drop-shadow(0 10px 9px rgba(0,0,0,.5))}
=======
...
>>>>>>> 5ea24599126c5d5d8fb2172e373aef06db3902b2
