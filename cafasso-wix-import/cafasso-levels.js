(() => {
  ...
  function ensureStyles() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
      .cafasso-level-pill{position:fixed;z-index:2147482999;left:18px;top:82px;display:flex;align-items:center;gap:8px;max-width:220px;padding:7px 11px;border:1px solid rgba(242,201,90,.32);border-radius:999px;background:rgba(8,37,40,.82);box-shadow:0 7px 18px rgba(0,0,0,.22);backdrop-filter:blur(9px);color:#fff8e9;font-family:Inter,system-ui,sans-serif;pointer-events:none}.cafasso-level-pill__icon{display:grid;place-items:center;width:22px;height:22px;border-radius:50%;border:1px solid rgba(242,201,90,.34);background:rgba(242,201,90,.12);color:#f4d889;font:700 12px/1 Georgia,serif}.cafasso-level-pill small{display:block;color:#d7c99c;font:850 6.5px/1 Inter,system-ui,sans-serif;letter-spacing:.13em;text-transform:uppercase}.cafasso-level-pill strong{display:block;margin-top:2px;color:#fff9e8;font:800 11px/1.05 Inter,system-ui,sans-serif}
