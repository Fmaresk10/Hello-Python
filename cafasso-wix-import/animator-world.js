(() => {
  ...
  function styles() {
    ...
    style.textContent = `
      ...
      @media(max-width:680px){html[data-cafasso-home-v2="1"] .side{display:none!important}.cafasso-world{min-height:100svh;padding:20px 14px 84px}.cafasso-world-hud{display:block}.cafasso-world-title{font-size:31px}.cafasso-world-sub{font-size:11px}.cafasso-world-stats{justify-content:flex-start;margin-top:13px}.cafasso-world-map{inset:0}.cafasso-world-zone-label{font-size:9px;padding:7px 9px}.cafasso-world-zone-copy{font-size:9px;max-width:105px}.cafasso-world-zone[data-zone="casa"]{left:3%;bottom:24%}.cafasso-world-zone[data-zone="patio"]{left:36%;bottom:12%}.cafasso-world-zone[data-zone="escuela"]{right:2%;top:29%}.cafasso-world-zone[data-zone="parroquia"]{right:2%;bottom:25%}.cafasso-world-panel,.cafasso-world-panel.near-casa,.cafasso-world-panel.near-patio,.cafasso-world-panel.near-escuela,.cafasso-world-panel.near-parroquia{left:14px;right:14px;bottom:79px;width:auto}.cafasso-home-profile-chip{z-index:5!important}}
    `;
