(() => {
  ...
  function styles() {
    ...
    style.textContent = `
      ...
      .cafasso-world-zone-label{display:inline-flex;align-items:center;gap:7px;padding:8px 11px;border-radius:7px 7px 4px 4px;background:linear-gradient(145deg,rgba(25,62,62,.86),rgba(8,35,39,.72));border:1px solid rgba(244,216,137,.58);border-left:3px solid rgba(244,216,137,.82);backdrop-filter:blur(7px);box-shadow:0 5px 12px rgba(0,0,0,.2),inset 0 1px rgba(255,250,220,.14);font:850 10px Inter,system-ui;letter-spacing:.11em;text-transform:uppercase}.cafasso-world-zone-label i{font-style:normal;font-size:15px;color:#F4D889}.cafasso-world-zone-copy{display:block;max-width:155px;margin:7px 0 0;font-size:11px;line-height:1.35;color:#F3F5E9;text-shadow:0 1px 8px rgba(0,0,0,.6)}
  ...
  function buildWorld() {
    ...
    const openPanel = zone => {
      const copy = {
        casa: ['Casa', 'Tu lugar para reconocerte, reunir tus huellas y volver a empezar.', 'Entrar a la Casa'],
        patio: ['Patio', 'El lugar donde lo que aprendés se vuelve encuentro, juego y comunidad.', 'Ir al Patio'],
        escuela: ['Escuela', 'El espacio para descubrir, crear y avanzar en tu formación.', 'Entrar a la Escuela'],
        parroquia: ['Parroquia', 'Un lugar para detenerte, escuchar, celebrar y volver al camino con una misión.', 'Entrar a la Parroquia']
      }[zone];
